...
-- the migration that first installed it. Stamped invalidation producers may
-- already hold replay-input journal locks, so they must not wait for replay
-- admission while holding those locks.
