...
#[cfg(test)]
pub(crate) use progress::reconcile_canonical_head_with_adapter_progress;
...
pub(crate) use progress::{
    reconcile_canonical_head, reconcile_intake_chain_task,
