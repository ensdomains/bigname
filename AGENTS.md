...
- `.refs/ens_v2/` — canonical post-audit ENSv2 contracts; admitted Sepolia deployment evidence is the archived 2026-06-29 artifacts under `contracts/deployments/sepolia-20260629-r1/` (the live `deployments/sepolia/` tree is upstream's unadmitted 2026-07-30 redeploy)
