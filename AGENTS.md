...
- Schema-v2 interpret writes identity rows, discovery edges, normalized
  ...
  rebuild seeds, child names from entry-creating events in an ENSv1→ENSv2
  migration registry that Project consumes as child rebuild seeds, and finitely retired
