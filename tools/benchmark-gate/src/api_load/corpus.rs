...
mod tests {
    ...
    pub(super) async fn install_name_visibility_schema(pool: &PgPool) {
        for statement in [
            ...
            "CREATE TABLE bigname_phase.resources (resource_id uuid NOT NULL, chain_id text NOT NULL, block_hash text NOT NULL, canonicality_state bigname_phase.canonicality_state NOT NULL, block_number bigint NOT NULL DEFAULT 0)",
