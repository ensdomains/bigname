...
pub(super) const LABEL_UNREGISTERED_SIGNATURE: &str = "LabelUnregistered(uint256,address)";
pub(super) const EXPIRY_UPDATED_SIGNATURE: &str = "ExpiryUpdated(uint256,uint64,address)";
pub(super) const SUBREGISTRY_UPDATED_SIGNATURE: &str =
    "SubregistryUpdated(uint256,address,address)";
pub(super) const RESOLVER_UPDATED_SIGNATURE: &str = "ResolverUpdated(uint256,address,address)";
pub(super) const TOKEN_REGENERATED_SIGNATURE: &str = "TokenRegenerated(uint256,uint256)";
pub(super) const PARENT_UPDATED_SIGNATURE: &str = "ParentUpdated(address,string,address)";
pub(super) const TOKEN_RESOURCE_SIGNATURE: &str = "TokenResource(uint256,uint256)";
