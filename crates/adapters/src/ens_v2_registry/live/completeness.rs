...
pub(in crate::ens_v2_registry) use requirements::has_authoritative_ens_v2_closure_through;
use requirements::{
...
impl FullSourceRawLogHistoryGuard {
    ...
    pub(in crate::ens_v2_registry) async fn ensure_proof_through(
        ...
        let requirements = load_required_watched_tuples_in_transaction(
        ...
        ensure_generation_bound_coverage(
            proof_transaction.as_mut(),
            &self.chain,
            &requirements,
    ...
    pub(in crate::ens_v2_registry) async fn ensure_proof_through_live_selection(
        ...
        let all_requirements = load_required_watched_tuples_in_transaction(
            proof_transaction.as_mut(),
            &self.chain,
            0,
            through_block,
