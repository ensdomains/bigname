...
const ENS_V2_REGISTRAR_STARTUP_VERSION_DECLARATION: i64 = 1;
const ENS_V2_RESOLVER_STARTUP_VERSION_DECLARATION: i64 = 1;
const ENS_V2_PERMISSIONS_STARTUP_VERSION_DECLARATION: i64 = 1;
