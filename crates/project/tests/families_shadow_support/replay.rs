...
/// manifest versions the events cite, then, through step 2's shared test helper
/// (tests/support/adapter_output.rs), token lineages, resources, name surfaces, surface
