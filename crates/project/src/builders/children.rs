...
///
/// A released ENSv2 child held by a migration proof or left as a released ENSv2 tombstone
/// publishes nothing and never falls back to ENSv1; any other child follows its selected
