...
-- expression over several indented lines, and the expected text keeps them.
...
CREATE OR REPLACE FUNCTION pg_temp.check_v1_lookahead_indexes(require_built boolean)
RETURNS void
LANGUAGE plpgsql
...
DO $$ BEGIN PERFORM pg_temp.check_v1_lookahead_indexes(false); END $$;
