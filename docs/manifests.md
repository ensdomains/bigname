...
Without an `ens_v2_migration_l1` manifest, these four mappings still produce their independently declared ordinary registrar rows but no ENSv1→ENSv2 migration evidence.
