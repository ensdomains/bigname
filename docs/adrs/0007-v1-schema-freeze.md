...
> that day predates the freeze; the twenty-three that landed after it, before this
...
was the head when it was written. Sixty-two schema-migrations follow it up to the
...
freeze — twenty-three landed after acceptance, which the next paragraphs
...
The remaining twenty-three landed after acceptance and before this ADR merged,
...
each in #934 and #939 (2026-09-23), none as a carve-out or with an amendment: under the effective date above they are the first
...
concurrent prebuild installer under `ops/address-history-indexes/`; #939's
...
#897, #899, #907, #902, #905, #912, #934 and #939 a thirteenth through
twenty-third — six index files, two check-only files, a constraint
replacement with its rename, and a new projection table — under the
