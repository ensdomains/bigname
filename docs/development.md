...
`/healthz` is an unversioned operator contract surface. The production public
edge exposes it for readiness checks, but it is not part of the versioned
`/v1` read API. Its frozen response may grow additively.
