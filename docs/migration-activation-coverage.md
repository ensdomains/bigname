...
| H-01 | blocked — the registrar-token group reaches the zero-predecessor refusal (`#822`); failure of the [physical Interpret batch](glossary.md#batch-grid) blocks all four groups | [validation/H-01.json](https://github.com/ensdomains/bigname/blob/d110108f2f098d1b43804c64c80d0b4588286326/validation/H-01.json) | `mixed_helper_batch_attributes_children_per_log` is adapter-level and contains no registry cleanup log; it does not prove the production-writer path |
...
| G-01 | blocked — the [ENSv1→ENSv2 migration boundary](glossary.md#migration-boundary) at block 235 reaches the zero-predecessor refusal (`#822`); the block 236 `Graveyard.clear` rule remains non-boundary, but the refusal prevents a durable Interpret commit or Project delivery at and after the boundary | [validation/G-01.json](https://github.com/ensdomains/bigname/blob/d110108f2f098d1b43804c64c80d0b4588286326/validation/G-01.json) | `cross_family_registrar_cleanup_and_historical_renewal_reject_lookalikes` |
