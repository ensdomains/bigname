...
`Transfer` has no other state delta, and emits a linked zero-resolver event when
the handoff retracts an already surfaced old-registry pointer. Later
