...
> **Our rule**: `manifests/mainnet/base/basenames/basenames_base_resolver/v1.toml` is the event-family admission boundary; `docs/api-v1-routes.md` keeps explicit declared inventory gaps visible to name, records, and diagnostic consumers.
