...
- All three protocols are locally deployable from pinned inputs: ENSv1
  hardhat-deploy artifacts (`.refs/ens_v1/deployments/`), ENSv2 sepolia-dev
  artifacts (`.refs/ens_v2/contracts/deployments/sepolia-dev/`, creation
