...
`base-mainnet`, two active glue families on the ethereum chain
(`basenames_l1_compat` v1 and `basenames_execution` v2), and the separate
...
chains and the glue families. They do not mirror the shadow `ens_execution`
